...
const Sidebar = () => {
  const { user, isSuperAdmin, ownClubId, logout } = useAuth();
  const { clubs, currentClubId, selectClub, currentClub } = useClub();
  const navigate = useNavigate();

  const activeClubId = isSuperAdmin ? (currentClubId || (clubs[0] ? clubs[0]._id : null)) : ownClubId;
    ...
    <aside style={{
      ...
      <div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h1 style={{ fontSize: '15px', letterSpacing: '-0.02em' }}>CLUB CORE</h1>
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '10px', color: 'var(--fg-dim)', textTransform: 'uppercase', marginBottom: '6px' }}>
            ACTIVE CLUB CONTEXT
          </div>
        ...
        <nav style={{ padding: '16px 0' }}>
          {activeClubId && navItems.map((item) => {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '10px' }}>
          <div style={{ fontWeight: '700', fontSize: '12px', color: 'var(--fg)' }}>
            {user?.name}
          </div>
